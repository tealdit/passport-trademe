...
function Strategy(options, verify) {
	...
	options = options || {};
	options.requestTokenURL = options.requestTokenURL || trademeConfig.oAuthBaseUrl + 'RequestToken';
	options.accessTokenURL = options.accessTokenURL || trademeConfig.oAuthBaseUrl + 'AccessToken';
	options.userAuthorizationURL = options.userAuthorizationURL || trademeConfig.oAuthBaseUrl + 'Authorize';
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
	...
	if (!this._skipExtendedUserProfile) {
		...
		var url = trademeConfig.apiBaseUrl + 'Member/Profile.json';

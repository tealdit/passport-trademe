...
function Strategy(options, verify) {
	...
	options = options || {};
    options.devEnv = options.devEnv || 'production';
    var apiUrls = {
        requestTokenURL: 'https://secure.trademe.co.nz/Oauth/RequestToken',
        accessTokenURL: 'https://secure.trademe.co.nz/Oauth/AccessToken',
        userAuthorizationURL: 'https://secure.trademe.co.nz/Oauth/Authorize',
        profileUrl: 'https://api.trademe.co.nz/v1/Member/Profile.json'
    };
    if(options.devEnv != 'production'){
        apiUrls.requestTokenURL = 'https://secure.tmsandbox.co.nz/Oauth/RequestToken';
        apiUrls.accessTokenURL = 'https://secure.tmsandbox.co.nz/Oauth/AccessToken';
        apiUrls.userAuthorizationURL = 'https://secure.tmsandbox.co.nz/Oauth/Authorize';
        apiUrls.profileUrl = 'https://api.tmsandbox.co.nz/v1/Member/Profile.json';
    }
    this.profileUrl = apiUrls.profileUrl;

	options.requestTokenURL = options.requestTokenURL || apiUrls.requestTokenURL;
	options.accessTokenURL = options.accessTokenURL || apiUrls.accessTokenURL;
	options.userAuthorizationURL = options.userAuthorizationURL || apiUrls.userAuthorizationURL;
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
	...
	if (!this._skipExtendedUserProfile) {
		...
		var url = this.profileUrl || 'https://api.trademe.co.nz/v1/Member/Profile.json';
